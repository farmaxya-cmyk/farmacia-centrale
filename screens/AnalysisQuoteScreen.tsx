...
export const AnalysisQuoteScreen = ({ user, showNotification, onNavigate }) => {
        ...
        <div className="p-4 md:p-8 animate-fade-in pb-32">
            ...
            {showAnalysisSection && (
                <div className="bg-white p-6 rounded-2xl shadow-lg animate-fade-in">
                    <h2 className="text-2xl font-bold text-slate-700 mb-2">2. Seleziona le Analisi</h2>
                     <p className="text-slate-500 mb-6">Le analisi consigliate in base ai tuoi obiettivi sono già state selezionate. Puoi aggiungerne o rimuoverne altre manualmente.</p>
